  ...
  var categorycheckbox = function () {
    if ($("div").hasClass("widget-category-checkbox")) {
      $(".widget-category-checkbox h5").on("click", function () {
        ...
        $(this)
          .closest(".widget-category-checkbox")
          .find(".content-wg-category-checkbox")
          .slideToggle("hidden");
      });
    }
  ...
  var sticky = function () {
    if ($("body").hasClass("sticky-scroll")) {
      $(document).ready(function () {
        ...
        var $footerOffsetTop =
          $(".po-sticky-footer").offset().top +
          $(".po-sticky-footer .content-inner.active").innerHeight();
          ...
          if ($window.scrollTop() + $sidebarHeight > $footerOffsetTop - 87) {
            $sidebar.css({
              top:
                0 -
                87 -
                ($window.scrollTop() + $sidebarHeight - $footerOffsetTop),
            });
          } else {
            $sidebar.css({ top: "0" });
          }
